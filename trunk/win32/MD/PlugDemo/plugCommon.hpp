...
#define __plugCommon_hpp__
	...
	#include "EEPROM_HASH\\eeprom_hash.h"
	#include "openGenieFramework\\NEO_PLUGING_EDITION\\opengenie.h"
	#include "COpCode.hpp"
	...
	inline const bool fileExists(const std::string& path,const bool testSize = false)
	{
